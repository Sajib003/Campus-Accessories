					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Official Accessories<span>.</span></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<?php
				$query = "SELECT * FROM product WHERE catagory='Official' ORDER BY id ASC";
				...
				?>
					...
					<form method="post" action="office.php?action=add&id=<?php echo $row["id"]; ?>">
					<div>
						<div class="product">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="office.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php

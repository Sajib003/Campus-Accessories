					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Electronics Accessories<span>.</span></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<?php
				$query = "SELECT * FROM product WHERE catagory='Electronics' ORDER BY id ASC";
				...
				?>
					...
					<form method="post" action="electronics.php?action=add&id=<?php echo $row["id"]; ?>">
					<div>
						<div class="product">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="electronics.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
